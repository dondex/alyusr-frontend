                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="block text-center">
                            ...
                            <h1 class="text-capitalize mb-5 text-lg">Achivements</h1>
        ...
        <section class="section doctors">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 mb-4 p-3">
                        <img class="w-100 shadow-1-strong rounded mb-4 h-50"
                        src="../assets/images/achievements/ach17.jpg"
                        
                        />

                        <img class="w-100 shadow-1-strong rounded mb-4 h-50"
                        src="../assets/images/achievements/ach18.jpg"
                    ...
                    <div class="col-lg-4 mb-4 p-3">
                        <img class="w-100 shadow-1-strong rounded mb-4 h-50"
                        src="../assets/images/achievements/ach19.jpg"
                    ...
                    <div class="col-lg-4 mb-4 p-3">
                        <img class="w-100 shadow-1-strong rounded mb-4 h-50"
                        src="../assets/images/achievements/ach33.jpg"
                    ...
                    <div class="col-lg-4 col-md-12 mb-4 p-3">
                        ...
                        <img class="w-100 shadow-1-strong rounded mb-4 h-50"
                        src="../assets/images/achievements/ach42.jpg"
...
export default {
    ...
    mounted() {
        ...
        // // Use Vue's events handling instead of jQuery
        // this.$el.querySelectorAll('input[name="shuffle-filter"]').forEach((input) => {
        //     input.addeventsListener('change', (evt) => {
