                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="block text-center">
                            ...
                            <h1 class="text-capitalize mb-5 text-lg">Staff</h1>
            ...
            <div class="container">
                ...
                <div class="row">
                   ...
                   <div class="col-lg-4 mb-4 p-3">
                    ...
                    <div class="col-lg-4 mb-4 p-3">
                        <img class="w-100 shadow-1-strong rounded mb-4 h-50"
                        src="../assets/images/staff/staff14.jpg"
                        
                        />

                        <img class="w-100 shadow-1-strong rounded mb-4 h-50"
                        src="../assets/images/staff/staff15.jpg"
                        
                        />
                    </div>
                    <div class="col-lg-4 col-md-12 mb-4 p-3">
                        <img class="w-100 shadow-1-strong rounded mb-4 h-50"
                        src="../assets/images/staff/staff16.jpg"
                        
                        />

                        <img class="w-100 shadow-1-strong rounded mb-4 h-50"
                        src="../assets/images/staff/staff17.jpg"
                    ...
                    <div class="col-lg-4 mb-4 p-3">
                        <img class="w-100 shadow-1-strong rounded mb-4 h-50"
                        src="../assets/images/staff/staff18.jpg"
